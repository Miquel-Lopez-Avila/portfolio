...
import { Wrapper, Primary, SubTitle, Title, Item, TitleItem, TitleDescription, Content, PageImage, FlexContainer } from './CookiesPolicy.styled';
            ...
            <Content>
              <div>
                <WrapperTitleWithUnderline underlineLeft paddingBottom={'15px'} marginBottom={'50px'}>
                  <Title>Consulta nuestra <Primary>Política de cookies</Primary></Title>
